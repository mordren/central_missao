...
<div class="max-w-6xl mx-auto px-4 py-6 sm:py-8">
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
        ...
        <a href="{{ route('activities.index') }}" class="text-xs text-brand-gray hover:text-white transition">← Missãos</a>
    </div>
        ...
        <table class="w-full min-w-[680px] divide-y divide-brand-dark-border">
            <thead>
                <tr class="bg-brand-dark-input/50">
                    ...
                    <th class="px-4 py-3 text-left text-xs font-bold text-brand-gray uppercase tracking-wider">Missão</th>
