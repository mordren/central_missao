        ...
        <div class="bg-brand-dark-card border border-brand-dark-border rounded-2xl p-5 sm:p-8">
            ...
            <div class="flex items-center justify-between flex-wrap gap-3">
                ...
                <div class="flex items-center gap-2">
                    {{-- QR Code: mostrar para coordenadores/admins (sempre) ou para usuários regulares em evento presencial --}}
                    @if (auth()->user()->canManageActivities() || $activity->type === 'evento_presencial')
            ...
            <script>
                ...
                function shareNative() {
                    navigator.share({
                        ...
                        text: @json($shareText),
                        url: @json(route('activities.share', $activity))
                    }).catch(function() {});
                }
            </script>
